...
const { getAllProduct, createProduct, updateProduct, updateProductByName, deleteProduct, deleteProductByName, getProductByCategory, getProductByDiscount, batchCreateProduct } = require("../controllers/product.controller")
